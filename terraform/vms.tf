locals {
  nodes = {
    "node-01" = { role = "history", ip = "172.31.1.10", mac = "00:15:5D:01:00:01" }
    "node-02" = { role = "proxy", ip = "172.31.1.11", mac = "00:15:5D:01:00:02" }
    "node-03" = { role = "ui", ip = "172.31.1.12", mac = "00:15:5D:01:00:03" }
  }
}
